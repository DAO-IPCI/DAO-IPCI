...
import 'creator/CreatorCommitment.sol';
import 'builder/Builder.sol';

/**
 * @title BuilderCommitment contract
 */
contract BuilderCommitment is Builder {
    /**
    ...
    function create(address _operator, address _token,
        ...
        var inst = CreatorCommitment.create(_operator, _token, _holder);
